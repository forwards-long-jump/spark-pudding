...
public class Drawing {
	// We don't really want to create these new items every time something is rendered
	 ...
	 */
	public static void drawWrappedString(String s, int x, int y, int maxWidth, Graphics2D g2d) {
